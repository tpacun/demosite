function addContent(query, content, textType) {
    ...
    if(expressCheckoutString) {
        ...
        addContent('.SeatingAreaOptionalInstructions', 'Optional messaging, edited in Settings > Configuration > System Setup > Custom Website Messages > Custom message for seating plans. This appears on chooseseats.aspx', 'editable')
