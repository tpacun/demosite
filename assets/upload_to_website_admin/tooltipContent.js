...
window.onload = () => {
    ...
    if(windowUrl.expressCheckout) {
        ...
        addContent('.MonthList', 'List of months generated by the system automatically based off of current date and furthest Event Instance marked as visible in the future', 'argument')
        ...
        addContent('.Event_Name', 'Can be edited in Admin > selected Event > Basic Details > Name', 'admin')
        addContent('.Event_Image', 'Pulls from the Image of specific Event. Heavily compressed by our system and only displays in a thumbnail size. Can be added in Admin > selected Event > Basic Details > Image', 'admin')
        addContent('span.Event_Description.Event_Detail', 'Can be edited in Admin > selected Event > Basic Details > Description', 'admin')
        ...
        addContent('.ChooseSeatsHeading', 'Can be added or edited under Settings > System Setup > Custom Website Messages.', 'editable')
        ...
        addContent('th.Area.Column', 'Default messaging', 'uneditable')
        addContent('th.SeatName.Column', 'Default messaging', 'uneditable')
        addContent('th.Type.Column', 'Default messaging', 'uneditable')
        addContent('td.Area.Column', 'Area name of selected ticket. Editable in Admin > Seating Plan', 'admin')
        addContent('td.SeatName.Column', 'Seat row and number', 'uneditable')
        addContent('td.Type.Column', 'Ticket Types available, editable in Admin > Pricing > Ticket Types', 'admin')
        addContent('p.Buttons', 'Default messaging', 'uneditable')
        ...
        addContent('a.CheckoutLink.LinkButton', 'Default messaging', 'uneditable')
